...
Developed using the **Godot Engine** and published on **itch.io**.
...
- Fight enemies
- Solve math questions to unlock paths and defeat bosses

The goal is to help players **practice math skills while enjoying a fast-paced game experience**.
